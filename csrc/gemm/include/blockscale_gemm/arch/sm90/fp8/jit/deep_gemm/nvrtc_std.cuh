// JIT-only header — do not include from AOT code paths.
// NVRTC-parsed `<type_traits>` / `<utility>` shim for the deep_gemm sm_90
// FP8 GEMM kernel. See ../README.md for the JIT subtree contract.
/*
